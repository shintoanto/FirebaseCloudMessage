package com.example.sendingpushnotifications
...
import com.example.sendingpushnotifications.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPDFFile(path: String) {
        ...
        try {
            ...
            document.add(tablex)
            val tables = Table(2)
            tables.addCell(getCell(" No. of boxes: 11", TextAlignment.CENTER))
            tables.addCell(getCell(" Address : Burgeman business tower  ", TextAlignment.LEFT))
            ...
            tables.addCell(getCell(" Destination: UAE", TextAlignment.CENTER))
            tables.addCell(getCell(" State Name : BurDubai  ", TextAlignment.LEFT))
            document.add(tables)
            val table2 = Table(
            ...
            tablelow.addCell(getCell("\n Printed by: E printer", TextAlignment.LEFT))
